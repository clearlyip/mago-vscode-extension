...
| `suppressExperimentalWarning`     | `false`   | application | Suppress the warning popup shown at startup reminding you that the Mago language server is experimental and has no stability guarantees.                                                                                                           |
